...
set_hitbox_value(AT_NSPECIAL, 1, HG_LIFETIME, 300); // One of the main factors to balance, sets the edgeguarding capability with it
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_GRAVITY, .8);  // Sets the ice projectile behavior, no ground interaction so it just slides
